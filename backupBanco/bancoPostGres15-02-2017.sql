...
-- Started on 2017-02-15 01:18:03
...
--
-- TOC entry 199 (class 1259 OID 32903)
...
--
-- TOC entry 198 (class 1259 OID 32901)
...
--
-- TOC entry 195 (class 1259 OID 32872)
...
--
-- TOC entry 194 (class 1259 OID 32870)
...
--
-- TOC entry 201 (class 1259 OID 32921)
...
--
-- TOC entry 200 (class 1259 OID 32919)
-- Name: logradouro_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 200
-- Name: logradouro_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
--
-- TOC entry 190 (class 1259 OID 32832)
...
--
-- TOC entry 189 (class 1259 OID 32830)
...
--
-- TOC entry 186 (class 1259 OID 32814)
...
--
-- TOC entry 187 (class 1259 OID 32817)
...
--
-- TOC entry 192 (class 1259 OID 32851)
...
--
-- TOC entry 193 (class 1259 OID 32858)
...
--
-- TOC entry 191 (class 1259 OID 32849)
...
--
-- TOC entry 197 (class 1259 OID 32884)
...
--
-- TOC entry 196 (class 1259 OID 32882)
...
--
-- TOC entry 2062 (class 2604 OID 32906)
...
--
-- TOC entry 2060 (class 2604 OID 32875)
...
--
-- TOC entry 2063 (class 2604 OID 32924)
-- Name: logradouro id; Type: DEFAULT; Schema: public; Owner: postgres
--
...
--
-- TOC entry 2058 (class 2604 OID 32835)
...
--
-- TOC entry 2057 (class 2604 OID 32822)
...
--
-- TOC entry 2059 (class 2604 OID 32854)
...
--
-- TOC entry 2061 (class 2604 OID 32887)
...
--
-- TOC entry 2183 (class 0 OID 16394)
-- Dependencies: 185
...
SELECT pg_catalog.setval('carona_id_seq', 9, true);
...
--
-- TOC entry 2199 (class 0 OID 32921)
-- Dependencies: 201
-- Data for Name: logradouro; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY logradouro (id, cep, estado, cidade, distrito, endereco, numero) FROM stdin;
1	25550-161	\N	São João de Meriti	Coelho da Rocha	Rua Florisbela - de 546	626
\.
...
-- Dependencies: 200
-- Name: logradouro_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('logradouro_id_seq', 1, true);
...
COPY parada (usuario_id, carona_id, logradouro_id) FROM stdin;
0	0	6
0	0	6
0	0	6
0	0	6
...
--
-- TOC entry 2065 (class 2606 OID 32827)
...
-- Completed on 2017-02-15 01:18:03
